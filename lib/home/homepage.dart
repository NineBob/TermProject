...
import 'package:projectma/home/SecondPage.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void getuniversities() async {
    try {
      ...
      final response =
      await _dio.get('http://universities.hipolabs.com/search?country=thailand');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text('List of universities in Thailand'),),floatingActionButton: FloatingActionButton(
        onPressed: handleClickGo, child: Text('US')),body: body);
  }
